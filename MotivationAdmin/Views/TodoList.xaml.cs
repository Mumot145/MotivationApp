...
namespace MotivationAdmin
{
    public partial class TodoList : ContentPage
    {
        ...
        public TodoList(ChatGroup _chatGroup)
        {
           ...
           // var strs = _chatGroup.ToDoList
          //  todoList =  _chatGroup.ToDoList.;
            foreach (var t in _chatGroup.ToDoList)
            {
                Debug.WriteLine(t.ToDo);
            }
        ...
        public async void OnSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            if (Xamarin.Forms.Device.OS != TargetPlatform.iOS && todo != null)
            {
                ...
                {
                    await DisplayAlert(todo.ToDo, "Press-and-hold to complete task " + todo.ToDo, "Got it!");
                }
                else
                {
                    // Windows, not all platforms support the Context Actions yet
                    if (await DisplayAlert("Mark completed?", "Do you wish to complete " + todo.ToDo + "?", "Complete", "Cancel"))
                    {
